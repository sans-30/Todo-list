...
function App() {
  ...
  return (
    ...
    <Navbar/>
      ...
      <h1 className='font-bold text-center text-xl'>MyTodos! - Manage your todos at one place</h1>
      ...
      <input className="my-4" onChange= {toggleFinished} type="checkbox" checked={showFinished} /> Show Completed Tasks
      ...
      <button onClick={(e)=> {handleDelete(e,item.id)}} className="bg-violet-800 hover:bg-violet-950 p-3 py-1 text-sm font-bold text-white rounded-md mx-1"><MdDeleteOutline /> </button>
      </div>
      </div>
    })}
      </div>
